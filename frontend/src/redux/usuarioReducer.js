...
export const adicionarUsuarios = createAsyncThunk('usuario/adicionarUsuarios', async (usuario) => {
...
const usuarioSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(adicionarUsuarios.fulfilled, (state, action) => {
                state.estado = ESTADO.OCIOSO;
                state.usuarios.push(action.payload.usuario);
                state.mensagem = action.payload.mensagem;
            })
            .addCase(adicionarUsuarios.pending, (state, action) => {
                state.estado = ESTADO.PENDENTE;
                state.mensagem = "Adicionando usuario...";
            })
            .addCase(adicionarUsuarios.rejected, (state, action) => {
